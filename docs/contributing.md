...
- Opening [GitHub issues](https://github.com/y-sunflower/d3scribe/issues) to list the bugs you've found
...
```bash
git clone https://github.com/github_user_name/d3scribe.git
cd d3scribe
git remote add upstream https://github.com/y-sunflower/d3scribe.git
```
...
Congrats! Once your PR is merged, it will be part of `d3scribe`.
