...
InteractivePlot().add_tooltip(df["species"])
```
...
InteractivePlot().add_tooltip(["S&P500", "CAC40", "Bitcoin"])
```
...
=== "Line chart"
    ...
    <iframe width="800" height="400" src="quickstart8.html" style="border:none;"></iframe>
